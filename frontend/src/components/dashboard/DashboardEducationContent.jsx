      ...
      >
        ...
        >
          {educationContents.length > 0 ? (
            educationContents.map((app) => (
              ...
              >
                ...
                <div className="d-flex align-items-center">
                  ...
                  <div className={"ms-2"}>
                    <div className="educationContentTitle">{app?.title}</div>
            ...
            <li className="text-center text-muted py-2">No Contents</li>
          )}
        </ul>
      </div>
        ...
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
          <div class="modal-content w-75">
            ...
            <div class="modal-body ">
              <input
                className="mb-2 search-field bg-color w-100 input-field "
                type="search"
                placeholder="Search"
              />
              ...
              <div class="modal-footer">
                <button type="button" class="btn w-100   modal-btn btn-primary">
                  Assign Ed Content
                </button>
              </div>
            </div>
